...
run_scenario <- 
  function(scenario = 1,
    ...
    # No transmission from Feb 20 to May 2021
    # June 21 onwards - R=3  
    #   
    ...
    rt <-    c(0.95,   0.95,   0.95,   0.95,   0.95,   0.95,   0.95,   3,   3)
    ...
    # first pulse, spread out hazard of 0.01 over 30 days right before 1st wave
    t_spread <- 30
    ...
    # Save output
    output_address <- paste0("output_cluster_scenario3/scenario_", scenario, ".rds")
